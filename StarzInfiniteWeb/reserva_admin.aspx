																	...
																	<ItemTemplate>
																		<tr>
																			...
																			<td>
																				...
																				<asp:LinkButton ID="lbtnCambiarFecha" Visible="false" CssClass="btn-sm btn-default" CommandArgument='<%# Eval("NRO_PNR") %>' runat="server" OnClick="lbtnCambiarFecha_Click" ToolTip="Cambiar la fecha">Cambiar fecha</asp:LinkButton><br /> <%--Visible='<%# Eval("ESTADO").ToString().Equals("EMITIDO".ToString()) ? Convert.ToBoolean(1) : Convert.ToBoolean(0) %>'--%>
